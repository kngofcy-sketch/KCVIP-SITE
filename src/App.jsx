...
const portfolio = [
  {
    img: "/static/gen_portfolio-music-production-686436.webp",
  ...
  {
    img: "/static/gen_portfolio-streetwear-157ec4.webp",
  ...
  {
    img: "/static/gen_portfolio-cover-art-a96d5e.webp",
    title: "Cover Art",
    ...
    <nav className={cn(
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 flex items-center justify-between h-[72px]">
        ...
        <a href="#hero" className="flex items-center gap-3 group shrink-0">
          <img src="/static/kc-logo.png" alt="KINGDOMCONNECT VIP" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(201,168,76,0.5)]" />
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src="/static/gen_kingdomconnect-hero-a18a14.webp" alt=""
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={cn("relative transition-all duration-1000", visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10")}>
            <div className="relative max-w-md mx-auto lg:mx-0">
              ...
              <img src="/static/kng-carly-official.png" alt="KNG_CARLY — Flagship Artist"
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-6 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              <img src="/static/kc-logo.png" alt="KINGDOMCONNECT VIP" className="w-9 h-9 object-contain drop-shadow-[0_0_8px_rgba(201,168,76,0.5)]" />
              <div>
